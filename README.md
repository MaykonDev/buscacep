...
<p align="center">Aplicação desenvolvida em Python para realizar busca de CEP, feita usando a biblioteca PySimpleGUI para a interface grafica e Requests para realizar a requisição da api.</p>
